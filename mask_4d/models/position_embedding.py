# Copyright (c) Facebook, Inc. and its affiliates. All Rights Reserved 新加位置编码
"""
...
import numpy as np
from mask_4d.utils.pc_util import shift_scale_points
...
class PositionEmbeddingCoordsSine(nn.Module):
    ...
    def get_fourier_embeddings(self, xyz, num_channels=None, input_range=None):
        ...
        final_embeds = torch.cat(final_embeds, dim=2).permute(0, 1, 2)
        return final_embeds
